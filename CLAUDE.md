...
- ✅ Nursing Module (nursing notes — admin-only update with discharge protection; vital signs — BP, HR, RR, temperature, oxygen saturation, glucometría — keep the 24h creator edit window with admin override)
