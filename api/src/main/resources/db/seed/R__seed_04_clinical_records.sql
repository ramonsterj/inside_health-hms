...
-- SEED-BUNDLE-VERSION: 2026-05-28b (see R__seed_01 header for the rule)
--
...
--   TABLETA INDIVIDUAL DE SEROLUX (SERTRALINA 50 MG)   → A161 (SERTRALINA SEROLUX 50 MG)
--   TABLETA DE QUTIAPINA (QUETIOXAL 300 MG)            → A150 (QUETIAPINA QUETIAZIC 300 MG)  (no QUETIOXAL 300mg in workbook)
--   TABLETA INDIVIDUAL CLONAZEPAM (RIVOTRIL 2 MG)      → A27  (CLONAZEPAM RIVOTRIL 2 MG)
--   TABLETA INDIVIDUAL CLONAZEPAM (RIVOTRIL 2 MG) II   → A28  (CLONAZEPAM EQUILIV 2 MG)
--   TABLETA INDIVIDUAL BIPERIDENO HC (BIPARK 2 MG)     → A14  (BIPERIDENO AKINETON 2 MG)     (no BIPARK in workbook)
--   AMPOLLA MIDAZOLAM (DORMICUM 15MG/3ML)              → D44  (MIDAZOLAM DORMICUM 15MG/3 ML)
--   AMPOLLA DE DIAZEPAM DORMICUM 10 MG                 → D18  (DIAZEPAM PARANTEN 10 MG)
--   TABLETA PREGABALINA (MARTESIA 75 MG)               → A129 (PREGABALINA MARTESIA 75 MG)
--   TABLETA INDIVIDUAL OLANZAPINA (ZYPREXA 5 MG)       → A109 (OLANZAPINA ZYPREXA 5 MG)
--   TABLETA INDIVIDUAL ALTRULINE (SERTRALINA) 50 MG    → A164 (SERTRALINA ALTRULINE 50 MG)
--   TABLETA DE SEROQUEL (QUETIAPINA 100 MG)            → A144 (QUETIAPINA QUETIAZIC 100 MG)
--   AMPOLLA DE OLANZAPINA (ZYPREXA IM 10 MG)           → D86  (OLANZAPINA ZYPREXA 10 MG)
-- KIT DE INGRESO, PANEL DE DROGAS, PRUEBAS HEPÁTICAS, T3-T4-TSH stay as
-- name-based lookups (they live in Laboratorios, not the pharmacy catalog).
...
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'ISRS para TDM severo, tomar con alimentos', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A161'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Juan' AND p.last_name = 'Pérez González' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 300mg', '300mg', 'ORAL', 'Cada noche', '21:00', 'Estabilizador para insomnio y ansiedad severa', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A150'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Juan' AND p.last_name = 'Pérez González' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 300mg', '300mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Antipsicótico para mania con psicosis', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A150'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Maria' AND p.last_name = 'Santos López' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Biperiden 2mg', '2mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Prevencion de efectos extrapiramidales', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A14'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Maria' AND p.last_name = 'Santos López' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Diazepam 10mg', '10mg', 'IM', 'PRN', 'SOS', 'Protocolo CIWA-Ar: administrar si puntaje >10', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'D18'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Pedro' AND p.last_name = 'García Hernández' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Olanzapina 5mg', '5mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Antipsicótico atípico para esquizofrenia paranoide', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A109'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Ana' AND p.last_name = 'Martínez Ruiz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Biperiden 2mg', '2mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Prevencion de efectos extrapiramidales', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A14'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Ana' AND p.last_name = 'Martínez Ruiz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 100mg', '100mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Antipsicótico para psicosis inducida por sustancias', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A144'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Luis' AND p.last_name = 'Morales Castro' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Una vez al dia', '08:00', 'ISRS para TEPT', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A164'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Carmen' AND p.last_name = 'Flores Mejía' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Una vez al dia', '08:00', 'ISRS para desregulación emocional del TLP', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A161'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Sofia' AND p.last_name = 'Ramírez Paz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Olanzapina 10mg', '10mg', 'IM', 'PRN', 'SOS', 'Para agitación psicomotora severa', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'D86'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Miguel' AND p.last_name = 'Torres Luna' AND a.status = 'DISCHARGED';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Olanzapina 5mg', '5mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Antipsicótico de mantenimiento', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A109'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Miguel' AND p.last_name = 'Torres Luna' AND a.status = 'DISCHARGED';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Una vez al dia', '08:00', 'ISRS para TAG y pánico', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A164'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Elena' AND p.last_name = 'Sánchez Rivas' AND a.status = 'DISCHARGED';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Una vez al dia', '08:00', 'ISRS para depresión en adulto mayor', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE kind = 'DRUG' AND sku = 'A161'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Francisco' AND p.last_name = 'Mendoza Aguilar' AND a.status = 'DISCHARGED';
