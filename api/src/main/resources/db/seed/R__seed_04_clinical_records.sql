...
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'ISRS para TDM severo, tomar con alimentos', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL DE SEROLUX (SERTRALINA 50 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Juan' AND p.last_name = 'Pérez González' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 300mg', '300mg', 'ORAL', 'Cada noche', '21:00', 'Estabilizador para insomnio y ansiedad severa', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA DE QUTIAPINA (QUETIOXAL 300 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Juan' AND p.last_name = 'Pérez González' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Clonazepam 2mg', '2mg', 'ORAL', 'PRN', 'SOS', 'Para ansiedad severa o agitación, max 2 dosis/dia', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL CLONAZEPAM (RIVOTRIL 2 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Juan' AND p.last_name = 'Pérez González' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'CUIDADOS_ESPECIALES', a.admission_date::DATE, 'Precauciones suicidas: monitoreo cada 15 minutos, sin objetos cortopunzantes, supervisión constante en baño', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Juan' AND p.last_name = 'Pérez González' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'ACTIVIDAD_FISICA', a.admission_date::DATE, 'Actividad supervisada en areas comunes, acompañamiento permanente', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Juan' AND p.last_name = 'Pérez González' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

-- Maria Santos López (Bipolar I manic + psychosis, 8 orders)
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 300mg', '300mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Antipsicótico para mania con psicosis', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA DE QUTIAPINA (QUETIOXAL 300 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Maria' AND p.last_name = 'Santos López' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Biperiden 2mg', '2mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Prevencion de efectos extrapiramidales', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL BIPERIDENO HC (BIPARK 2 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Maria' AND p.last_name = 'Santos López' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Midazolam 15mg', '15mg', 'IM', 'PRN', 'SOS', 'Para agitación severa, max 2 dosis/dia', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'AMPOLLA MIDAZOLAM (DORMICUM 15MG/3ML)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Maria' AND p.last_name = 'Santos López' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'CUIDADOS_ESPECIALES', a.admission_date::DATE, 'Precauciones por agitación, ambiente bajo estímulo, limitar visitas', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Maria' AND p.last_name = 'Santos López' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'ORDENES_MEDICAS', a.admission_date::DATE, 'Signos vitales cada 8 horas, reportar FC>120 o PA>160/100', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Maria' AND p.last_name = 'Santos López' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

-- Pedro García Hernández (Alcohol withdrawal, 7 orders)
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Diazepam 10mg', '10mg', 'IM', 'PRN', 'SOS', 'Protocolo CIWA-Ar: administrar si puntaje >10', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'AMPOLLA DE DIAZEPAM DORMICUM 10 MG'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Pedro' AND p.last_name = 'García Hernández' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Pregabalina 75mg', '75mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Para ansiedad y neuropatía por abstinencia', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA PREGABALINA (MARTESIA 75 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Pedro' AND p.last_name = 'García Hernández' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'CUIDADOS_ESPECIALES', a.admission_date::DATE, 'Protocolo CIWA-Ar cada 4 horas, precauciones contra convulsiones, barandales elevados', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Pedro' AND p.last_name = 'García Hernández' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

-- Ana Martínez Ruiz (Schizophrenia, 7 orders)
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Olanzapina 5mg', '5mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Antipsicótico atípico para esquizofrenia paranoide', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL OLANZAPINA (ZYPREXA 5 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Ana' AND p.last_name = 'Martínez Ruiz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Clonazepam 2mg', '2mg', 'ORAL', 'PRN', 'SOS', 'Para ansiedad o agitación, max 2 dosis/dia', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL CLONAZEPAM (RIVOTRIL 2 MG) II'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Ana' AND p.last_name = 'Martínez Ruiz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'CUIDADOS_ESPECIALES', a.admission_date::DATE, 'Monitoreo de conducta paranoide, sin restricción de movilidad', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Ana' AND p.last_name = 'Martínez Ruiz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'ORDENES_MEDICAS', a.admission_date::DATE, 'Control de PA cada 8 horas (paciente hipertensa). Reportar PA >150/95', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Ana' AND p.last_name = 'Martínez Ruiz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

-- Luis Morales Castro (Polysubstance + psychosis, 6 orders)
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 100mg', '100mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Antipsicótico para psicosis inducida por sustancias', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA DE SEROQUEL (QUETIAPINA 100 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Luis' AND p.last_name = 'Morales Castro' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'CUIDADOS_ESPECIALES', a.admission_date::DATE, 'Monitoreo de abstinencia, ambiente controlado, reportar craving o conducta desorganizada', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Luis' AND p.last_name = 'Morales Castro' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

-- Carmen Flores Mejía (PTSD + suicidal ideation, 5 orders)
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Una vez al dia', '08:00', 'ISRS para TEPT', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL ALTRULINE (SERTRALINA) 50 MG'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Carmen' AND p.last_name = 'Flores Mejía' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Clonazepam 2mg', '2mg', 'ORAL', 'Cada noche', '21:00', 'Para insomnio y pesadillas asociadas a TEPT', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL CLONAZEPAM (RIVOTRIL 2 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Carmen' AND p.last_name = 'Flores Mejía' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'CUIDADOS_ESPECIALES', a.admission_date::DATE, 'Precauciones suicidas nivel moderado: monitoreo cada 30 minutos, supervisión en baño', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Carmen' AND p.last_name = 'Flores Mejía' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

-- Roberto Díaz Vargas (Bipolar II depressive, 4 orders)
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 300mg', '300mg', 'ORAL', 'Cada noche', '21:00', 'Estabilizador para episodio depresivo bipolar', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA DE QUTIAPINA (QUETIOXAL 300 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Roberto' AND p.last_name = 'Díaz Vargas' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Una vez al dia', '08:00', 'ISRS para desregulación emocional del TLP', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL DE SEROLUX (SERTRALINA 50 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Sofia' AND p.last_name = 'Ramírez Paz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 100mg', '100mg', 'ORAL', 'Cada noche', '21:00', 'Para insomnio y estabilización emocional', 'AUTORIZADO', (SELECT id FROM inventory_items WHERE name = 'TABLETA DE SEROQUEL (QUETIAPINA 100 MG)'), a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Sofia' AND p.last_name = 'Ramírez Paz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
INSERT INTO medical_orders (admission_id, category, start_date, observations, status, created_at, updated_at, created_by)
SELECT a.id, 'CUIDADOS_ESPECIALES', a.admission_date::DATE, 'Protocolo de seguridad por autolesiónes: sin objetos cortopunzantes, revisión de pertenencias, supervisión en baño', 'ACTIVA', a.admission_date, a.admission_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Sofia' AND p.last_name = 'Ramírez Paz' AND a.type = 'HOSPITALIZATION' AND a.status = 'ACTIVE';
...
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Olanzapina 10mg', '10mg', 'IM', 'PRN', 'SOS', 'Para agitación psicomotora severa', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE name = 'AMPOLLA DE OLANZAPINA (ZYPREXA IM 10 MG)'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Miguel' AND p.last_name = 'Torres Luna' AND a.status = 'DISCHARGED';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Olanzapina 5mg', '5mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Antipsicótico de mantenimiento', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL OLANZAPINA (ZYPREXA 5 MG)'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Miguel' AND p.last_name = 'Torres Luna' AND a.status = 'DISCHARGED';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Biperiden 2mg', '2mg', 'ORAL', 'Cada 12 horas', '08:00, 20:00', 'Prevencion de extrapiramidales', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL BIPERIDENO HC (BIPARK 2 MG)'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Miguel' AND p.last_name = 'Torres Luna' AND a.status = 'DISCHARGED';
...
INSERT INTO medical_orders (admission_id, category, start_date, observations, status, discontinued_at, discontinued_by, created_at, updated_at, created_by)
SELECT a.id, 'CUIDADOS_ESPECIALES', a.admission_date::DATE, 'Monitoreo de conducta psicótica', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Miguel' AND p.last_name = 'Torres Luna' AND a.status = 'DISCHARGED';

-- Elena Sánchez Rivas (GAD + Panic, 5 orders)
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Una vez al dia', '08:00', 'ISRS para TAG y pánico', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL ALTRULINE (SERTRALINA) 50 MG'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Elena' AND p.last_name = 'Sánchez Rivas' AND a.status = 'DISCHARGED';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Clonazepam 2mg', '2mg', 'ORAL', 'PRN', 'SOS', 'Para crisis de pánico', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL CLONAZEPAM (RIVOTRIL 2 MG)'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Elena' AND p.last_name = 'Sánchez Rivas' AND a.status = 'DISCHARGED';
...
INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Sertralina 50mg', '50mg', 'ORAL', 'Una vez al dia', '08:00', 'ISRS para depresión en adulto mayor', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE name = 'TABLETA INDIVIDUAL DE SEROLUX (SERTRALINA 50 MG)'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Francisco' AND p.last_name = 'Mendoza Aguilar' AND a.status = 'DISCHARGED';

INSERT INTO medical_orders (admission_id, category, start_date, medication, dosage, route, frequency, schedule, observations, status, discontinued_at, discontinued_by, inventory_item_id, created_at, updated_at, created_by)
SELECT a.id, 'MEDICAMENTOS', a.admission_date::DATE, 'Quetiapina 100mg', '100mg', 'ORAL', 'Cada noche', '21:00', 'Coadyuvante para insomnio', 'DESCONTINUADO', a.discharge_date, a.treating_physician_id, (SELECT id FROM inventory_items WHERE name = 'TABLETA DE SEROQUEL (QUETIAPINA 100 MG)'), a.admission_date, a.discharge_date, a.treating_physician_id FROM admissions a JOIN patients p ON a.patient_id = p.id WHERE p.first_name = 'Francisco' AND p.last_name = 'Mendoza Aguilar' AND a.status = 'DISCHARGED';
